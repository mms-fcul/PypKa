...
class ProteinGraph(object):
    ...
    def update_graph(self):
        ...
        for p, q in combinations(iter(self.pc.residue_variables.items()), 2):
            ...
            capacity = (
                self.pc.normalized_interaction_energies[
                    p_deprot_instance, q_deprot_instance
                ]
                / 2.0
            )
            ...
            capacity = (
                self.pc.normalized_interaction_energies[
                    p_prot_instance, q_deprot_instance
                ]
                / 2.0
            )
            ...
            capacity = (
                self.pc.normalized_interaction_energies[
                    p_deprot_instance, q_prot_instance
                ]
                / 2.0
            )
            ...
            capacity = (
                self.pc.normalized_interaction_energies[
                    p_prot_instance, q_prot_instance
                ]
                / 2.0
            )
