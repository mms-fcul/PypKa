            ...
            for atom in atoms.childNodes:
                ...
                if pkas:
                    for pka in pkas.childNodes:
                        print "          Value:            ", pka.attributes[
                            "Value"
                        ].value
                        print "          Temperature:      ", pka.attributes[
                            "Temperature"
                        ].value
                        print "          pH:               ", pka.attributes["pH"].value
                        print "          Solvent:          ", pka.attributes[
                            "Solvent"
                        ].value
                        print "          Salt type:        ", pka.attributes[
                            "Salt_type"
                        ].value
                        print "          Salt conc.:       ", pka.attributes[
                            "Salt_conc."
                        ].value
                        print "          Titratable group: ", pka.attributes[
                            "Titratable_group"
                        ].value
                        print "          Most bio. rel.:   ", pka.attributes[
                            "Most_bio._relavent"
                        ].value
                        print "          Reference:        ", pka.attributes[
                            "Reference"
                        ].value
                        print "          Comment:          ", pka.attributes[
                            "Comment"
                        ].value
...
if __name__ == "__main__":
    ...
    parser.add_option(
        ...
        action="store",
        type="string",
        help="Mol2 file holding the ligand coordinates. Default: %s",
        default="5fiv_ligand.mol2",
    )
    parser.add_option(
        "--testall",
        dest="testall",
