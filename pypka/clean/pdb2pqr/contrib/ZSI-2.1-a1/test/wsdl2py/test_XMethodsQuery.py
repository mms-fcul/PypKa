...
def dispatch():
    ...
    suite.addTest(
        unittest.makeSuite(
            XMethodsQueryTest, "test_dispatch", suiteClass=ServiceTestSuite
        )
    )
    return suite
...
def local():
    ...
    suite = ServiceTestSuite()
    suite.addTest(
        unittest.makeSuite(XMethodsQueryTest, "test_local", suiteClass=ServiceTestSuite)
    )
    return suite
...
def net():
    ...
    suite = ServiceTestSuite()
    suite.addTest(
        unittest.makeSuite(XMethodsQueryTest, "test_net", suiteClass=ServiceTestSuite)
    )
    return suite
...
def all():
    ...
    suite = ServiceTestSuite()
    suite.addTest(
        unittest.makeSuite(XMethodsQueryTest, "test_", suiteClass=ServiceTestSuite)
    )
    return suite
