...
class TestCase(unittest.TestCase):
    ...
    def check_valid_dateTime(self):
        ...
        for i in (
            "1968-04-02T13:20:00",
            "1968-04-02T13:20:15.5",
            "1968-04-02T13:20:00-05:00",
            "1968-04-02T13:20:00Z",
        ):
    ...
    def check_parse_microseconds(self):
        ...
        self.failUnless(
            data == good, "did not parse something %s, not equal %s" % (data, good)
        )
    ...
    def check_parse_microseconds2(self):
        ...
        self.failUnless(
            data == good, "did not serialze correctly %s, not equal %s" % (data, good)
        )
    ...
    def broke_invalid_date_april31(self):
        ...
        self.failUnlessRaises(
            Exception, typecode.text_to_data, "1968-04-31", None, None
        ),
...
for t in [
    i[0].split(_SEP)
    for i in filter(lambda i: callable(i[1]), TestCase.__dict__.items())
]:
    test = ""
    for f in t:
        test += f
