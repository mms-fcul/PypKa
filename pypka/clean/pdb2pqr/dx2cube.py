...
parser.add_argument("dx_input", help="Name of the dx_input file (required arguement)")
parser.add_argument("pqr_input", help="Name of the pqr_input file (required arguement)")
parser.add_argument("output", help="Name of the output file (required arguement)")
...
try:
    with open(args.dx_input, "r") as in_f, open(args.output, "w") as out_f, open(
        args.pqr_input, "r"
    ) as in_pqr:
        out_f.write(
