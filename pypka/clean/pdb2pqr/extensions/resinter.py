...
def addExtensionOptions(extensionGroup):
    ...
    Add options.
    """
    extensionGroup.add_option(
        "--residue_combinations",
        dest="residue_combinations",
        action="store_true",
        default=False,
        help="""Remap residues to different titration states and rerun resinter appending output.
...
re-tested result is different. This warning should not be possible if used with --noopt.""",
    ...
    extensionGroup.add_option(
        ...
        action="store_true",
        default=False,
        help="""Remap residues to ALL possible titration state combinations and rerun resinter appending output.
...
def write_all_residue_interaction_energies_combinations(
    routines, output, options, all_residue_combinations=False
):
    """
...
def create_resinter_output(
    ...
    if residue_combinations or all_residue_combinations:
        write_all_residue_interaction_energies_combinations(
            routines, output, options, all_residue_combinations=all_residue_combinations
        )
    else:
        save_residue_interaction_energies(routines.protein.getResidues(), output)
