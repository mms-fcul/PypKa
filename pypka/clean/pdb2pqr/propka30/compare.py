...
if False:
    ...
    def compareWithExperiment(
        protein, file=None, list=None, set=None, label="ALL", **argv
    ):
        """
            ...
            for atom in residue.atoms:
                ...
                if residue.label in [
                    ...
                    if atom.element == "C" and atom.name not in ["C", "CA"]:
                        ...
                        pka_print(
                            "%s  %-3s %6.2lf %6.2lf"
                            % (residue.label, atom.name, test_distance, contribution)
                        )
...
def regression(points):
    ...
    slope = (number_of_points * sum_xy - sum_x * sum_y) / (
