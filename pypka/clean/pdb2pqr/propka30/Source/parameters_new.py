...
def getCoulombParameters(label=None):
    ...
    """
    CoulombParameters = {}
    CoulombParameters["Linear"] = {
        "cutoff": [4.0, 7.0],
        "max_dpka": 2.40,
        "scaled": True,
    }
    CoulombParameters["Coulomb"] = {
        "cutoff": [4.0, 10.0],
        "diel": 80.00,
        "scaled": True,
    }
    CoulombParameters["DistanceScaledCoulomb"] = {
        "cutoff": [4.0, 10.0],
        "diel": [30.0, 160.0],
        "scaled": False,
    }
...
def getDesolvationParameters(label=None):
    ...
    DesolvationParameters["propka2"] = {
        "allowance": 400.00,
        "prefactor": -0.01,
        "local": -0.07,
        "radii": getLocalRadii(),
    }
    DesolvationParameters["ContactModel"] = {
        "allowance": 400.00,
        "prefactor": -0.01,
        "local": -0.07,
        "radii": getLocalRadii(),
    ...
    DesolvationParameters["ScaledVolumeModel"] = {
        "allowance": 0.00,
        "prefactor": -13.50,
        "surface": 0.00,
        "volume": getVanDerWaalsVolumes(),
...
def getVanDerWaalsVolumes():
    ...
    VanDerWaalsVolume = {
        "C": 1.40,  # 20.58   1.70   all 'C' and 'CA' atoms
...
def getHydrogenBondParameters(type=None):
    ...
    if type == "back-bone":
        ...
        pka_print(
            "cannot determine what type of hydrogen-bonding interactions you want type=\"%s\" ['back-bone', 'side-chain']"
            % (label)
        )
        sys.exit(9)
