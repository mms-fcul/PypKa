...
c a third field in pls takes into account the correspondence nprobj-npr
        ...
        integer numbmol,ii,jj,nside,dim,dim1,kind,realsiz
...
c b++++++++++++++++
        if((nprobj+limu-liml+1).gt.nprtobj)then
          ...
          i_coi= memalloc(i_coi,realsiz,nprtobj*5)
        endif
c e++++++++++++++++
...
c e++++++++++++++++++++
	...
	nprp=npr
70	continue
	write(6,*)'# of atom-atom pairs = ',npr
...
c assign memory to expos if needed
        ...
        nacct=nacct+1000
        i_expos= memalloc(i_expos,realsiz,3*nacct)
        endif
...
c e++++++++++++++++++++++++
	...
	i_pls= memalloc(i_pls,0,0)
c b++++++++++++
        i_coi= memalloc(i_coi,0,0)
c e++++++++++++++
...
c OBS: it is advisable to improve the sideinter estimation as a function of smallest object dimensions
c and of radprobe as well, here probably is too small!!
...
c	write(6,*)'moment debug',omin,omax
          h=1./scale
