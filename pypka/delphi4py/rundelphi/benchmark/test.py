...
cpu_sockets =  int(sb.check_output('cat /proc/cpuinfo | grep "physical id" | sort -u | wc -l', shell=True))

if run_sockets > cpu_sockets:
    raise Exception('Asked for more sockets than it is possible')

pool = Pool(processes=ncpus)
for task in range(run_sockets):
    result = pool.apply_async(runCalculations, args=(job, ))
    os.system("taskset -p -c {0} {1}" % ('0-7', p.pid))
...
py_rmaxdim = delphi1.delphi(py_igrid, py_scale, py_repsin, py_repsout,
                            py_radprb, py_conc, py_ibctyp, py_res2, py_nlit,
                            py_acent, py_energy, py_site, py_in_pdb, py_in_crg,
                            py_in_siz, py_in_pdb_len, py_in_crg_len, py_in_siz_len,
                            natom, nobject, py_i_atpos, py_i_rad3, py_i_chrgv4, py_i_atinf,
...
esolvation = delphi2.delphi(py_igrid, py_scale, py_repsin, py_repsout,
                            py_radprb, py_conc, py_ibctyp, py_res2, py_nlit,
                            py_acent, py_energy, py_site,
                            py_nonit, py_relfac, py_relpar, py_pbx, py_pby,
                            py_in_pdb, py_in_crg,
                            py_in_siz, py_in_frc,
                            py_in_pdb_len, py_in_crg_len, py_in_siz_len,
                            natom, nmedia, nobject, py_i_atpos, py_i_rad3,
                            py_i_chrgv4, py_i_atinf,
                            py_i_medeps, py_i_iatmmed, py_i_dataobject,
                            py_i_phimap4, py_scale1,
