...
f2py3.6 -c -m rundelphi creapdb.so memalloc.so surfacemodule.so solvermodule.so nlsolvermodule.so wrtsit4.so scale.so delphi.f elb.f namlen3.f qinttot.f cputime.f timef.f up.f wrt4.f rent4.f rdhrad.f ichash4.f rdhcrg.f cent4.f setrc4d.f getatm2.f radass4.f crgass4.f chkcrg.f form2.f rfind4.f cfind4.f extrmobjects.f extrm.f off4.f wrtprm.f grdatm.f crgarr.f distrTOpoint.f scaler4.f epsmak.f setout.f vwtms2.f distobj.f sas.f cube.f indver.f watput.f objvertices.f wrtatd.f dbsfd.f mkdbsf.f wrteps4b.f setfcrg.f setcrg.f setbc4.f relfac4b.f wrtgcrg.f phintp4.f nitit.f conplt.f itit4j.f omalt.f encalc4.f nlener.f anagrd4.f react2.f clb.f rdiv.f watpte.f rforce.f ts.f phicon.f expand4.f wrtphi.f wrtsurf.f fxhl.f mkvtl.f ex.f msrf.f --f77exec="$fortran_compiler" --f77flags="$flags"

ln -s ../readFiles/readFiles.so .
mv rundelphi*.so rundelphi.so
