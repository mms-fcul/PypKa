...
if [ $precision == "single" ]
then
    flags="-DGNU -fcray-pointer -ffixed-line-length-none -O3 -cpp -static -static-libgfortran -static-libgcc"
elif [ $precision == "double" ]
then
    flags="-DGNU -fcray-pointer -ffixed-line-length-none -O3 -cpp -DDP -fdefault-real-8 -static -static-libgfortran -static-libgcc"
    flags="-g -O3 -fcray-pointer -ffixed-line-length-none -DGNU -DIFC -DDP -cpp -fdefault-real-8 -lstdc++ -static -static-libgfortran -static-libgcc"
fi
