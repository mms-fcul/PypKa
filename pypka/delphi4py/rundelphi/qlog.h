...
c b+++++++++++++++++++++++++++++++++++w Oct 2000
	...
	logical isitsf,ionlymol,debug,isitpot,verbose,isitdeb,ivertnorm
	logical idebwrt
	
c NanoShaper parameter
	integer isurftype,meshlen
c CUDASolver parameter
	integer isolvarch
c e++++++++++++++++++++++++++++++++++++++++++++

	character*80 epsnam,phinam,frcnam,mpdbnam,updbnam,ufrcnam
	character*80 srfnam,debnam,meshnam
...
c
	common
     ...
     &  isitpot,verbose,isitdeb,ivertnorm,idebwrt
c
	common
...
c
	common
     ...
     &  realsiz,npotenziali,nvincfit,debnamlen,isurftype,isolvarch
c
     ...
     &  prmnam,pdbnam,siznam,crgnam,phiinam,frcinam,toplbl,debnam,meshnam
c
