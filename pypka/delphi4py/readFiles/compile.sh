...
# f2py command
f2py2.7 -c -m readFiles memalloc.so delphi1.f qinttot.f namlen3.f up.f rdhrad.f elb.f rent4.f rdhcrg.f cent4.f setrc4d.f getatm2.f form2.f radass4.f rfind4.f crgass4.f cfind4.f chkcrg.f ichash4.f extrm.f off4.f --f77exec="$compiler" --f77flags="$flags"
