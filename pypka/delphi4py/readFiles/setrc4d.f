...
c
	...
	character*16 crgstr
	character*5 atmstr
	dimension atpos(3*natom),rad3(natom),chrgv4(natom),xo(3)
...
c	  PRINT *, '1', atinf(i)(1:5), atinf(i)(7:9), atinf(i)(12:15), atinf(i)(11:11)
c
	  call up(atm,6)
	  call elb(atm,6)
	  call up(res,3)
...
c	do i=1,natom
c	   PRINT *, '2', atinf(i)(1:5), atinf(i)(7:9), atinf(i)(12:15), atinf(i)(11:11)
c	end do

c	PRINT *, ipdbwrt, iatout
c unformatted write...
	if(ipdbwrt) then
...
c
c 	do i=1,natom
c	   PRINT *, '4', atinf(i)(1:5), atinf(i)(7:9), atinf(i)(12:15), atinf(i)(11:11)
c	end do
c	do i=1,natom
c	   PRINT *, '4', atinf(i)
c	end do
